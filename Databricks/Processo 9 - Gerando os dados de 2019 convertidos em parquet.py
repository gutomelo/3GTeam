...
# Instalando a biblioteca secundária
!pip install xlrd
...
df = spark.read.schema(schema_2018_2019).load(f"{base}/2019/RAIS_VINC_PUB_NORTE.txt", format="csv", header="true", delimiter=";", encoding="windows-1252")
...
df = spark.read.schema(schema_2018_2019).load(f"{base}/2019/RAIS_VINC_PUB_SP.txt", format="csv", header="true", delimiter=";", encoding="windows-1252")
df = df.withColumn("Ano", lit("2019"))
df.createOrReplaceTempView("view_df")
...
df = spark.read.schema(schema_2018_2019).load(f"{base}/2019/RAIS_VINC_PUB_SUL.txt", format="csv", header="true", delimiter=";", encoding="windows-1252")
df = df.withColumn("Ano", lit("2019"))
df.createOrReplaceTempView("view_df")
...
df = spark.read.schema(schema_2018_2019).load(f"{base}/2019/RAIS_VINC_PUB_NORDESTE.txt", format="csv", header="true", delimiter=";", encoding="windows-1252")
df = df.withColumn("Ano", lit("2019"))
df.createOrReplaceTempView("view_df")
...
df = spark.read.schema(schema_2018_2019).load(f"{base}/2019/RAIS_VINC_PUB_CENTRO_OESTE.txt", format="csv", header="true", delimiter=";", encoding="windows-1252")
df = df.withColumn("Ano", lit("2019"))
df.createOrReplaceTempView("view_df")
...
df = spark.read.schema(schema_2018_2019).load(f"{base}/2019/RAIS_VINC_PUB_MG_ES_RJ.txt", format="csv", header="true", delimiter=";", encoding="windows-1252")
df = df.withColumn("Ano", lit("2019"))
df.createOrReplaceTempView("view_df")
